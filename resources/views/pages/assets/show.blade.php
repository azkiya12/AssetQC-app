    ...
    {{-- <div class="panel-header bg-primary-gradient">
        <div class="py-5 page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h2 class="pb-0 text-white fw-bold">{{ $item->name }}</h2>
                    <h2 class="badge badge-warning mb-2 text-white">{{ $item->asset_taq }}</h2>
                </div>
                    ...
                    <div class="card-header">
                        <div class="card-head-row">
                            <div class="card-title">
                                ...
                                <span class="card-text badge-count badge-primary badge-pill py-1">{{ $item->asset_taq }}</span>
                            </div>
                            <div class="card-tools">
                                <a href="{{ route('asset.edit', $item->id) }}" class="btn btn-outline-info btn-round btn-sm mr-2">
                                    <span class="btn-label">
                                        <i class="fa fa-pencil"></i>
                                    </span>
                                    Edit
                                </a>
                                <a href="#" class="btn btn-outline-info btn-round btn-sm">
                                    <span class="btn-label">
                                                        ...
                                                        <ul class="specification-list">
                                                            <li>
                                                                ...
                                                                <span class="status-specification">
                                                                    <span class="badge badge-{{$item->status->warna}} ">{{ $item->status->name }}</span>
                                                                </span>
                                                            </li>
                                                            <li>
